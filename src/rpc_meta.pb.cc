...
static void InitDefaultsRpcMeta() {
  ...
  {
    void* ptr = &::_RpcMeta_default_instance_;
    new (ptr) ::RpcMeta();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::RpcMeta::InitAsDefaultInstance();
}
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::RpcMeta, service_id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::RpcMeta, method_id_),
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::RpcMeta* Arena::CreateMaybeMessage< ::RpcMeta >(Arena* arena) {
  return Arena::CreateInternal< ::RpcMeta >(arena);
}
}  // namespace protobuf
}  // namespace google
